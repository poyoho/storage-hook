...
export function useLocalStorage<Options extends OptionMap = OptionMap>(options: Options) {
...
export function useSessionStorage<Options extends OptionMap = OptionMap>(options: Options) {
